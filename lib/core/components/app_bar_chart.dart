        ...
        for (final PollChoiceGroup i in questions) ...[
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${questions.indexOf(i) + 1}. ${i.question}',
                  style: style,
                ),
                ...
                for (final PollChoice o in i.choices) ...[
                  Column(
                    ...
                    children: [
                      Builder(
                        builder: (context) {
                          double getPercentWhole(int total, int count) {
                          ...
                          final double percentage = getPercent(total, o.count);
                          final double percentageWhole = getPercentWhole(
                            total,
                            o.count,
                          );

                          final String leadingString = _getLeadingString(
                            index,
                            type: i.type,
                          );
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    LinearPercentIndicator(
                                      ...
                                      progressColor: o.color ?? _palette[index],
                                      animation: true,
                      ...
                      if (i.choices.last != o) ...[SizedBox(height: 8.h)],
                    ],
                  ),
                ],
              ],
          ...
          if (questions.last != i) ...[SizedBox(height: 40.h)],
        ],
      ],
    );
  }
